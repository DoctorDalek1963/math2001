...
example {u v x y A B : ℝ}
    ...
    (h4 : x ≤ B) (h5 : y ≤ B) (h6 : 0 ≤ u)
    (h7 : 0 ≤ v) (h8 : u < A) (h9 : v < A)
...
example {n : ℤ} (hn : n ≥ 10) : n ^ 4 - 2 * n ^ 2 > 3 * n ^ 3 := by
  have h1 : n ^ 4 - 3 * n ^ 3 - 2 * n ^ 2 - 1 > 0 := by
    calc
      n ^ 4 - 3 * n ^ 3 - 2 * n ^ 2 - 1
      _ = n * n ^ 3 - 3 * n ^ 3 - 2 * n ^ 2 - 1 := by ring
      _ ≥ 10 * n ^ 3 - 3 * n ^ 3 - 2 * n ^ 2 - 1 := by rel [hn]
      _ = 7 * n * n ^ 2 - 2 * n ^ 2 - 1 := by ring
      _ ≥ 7 * 10 * n ^ 2 - 2 * n ^ 2 - 1 := by rel [hn]
      _ = 68 * n * n - 1 := by ring
      _ ≥ 68 * 10 * 10 - 1 := by rel [hn]
      _ > 0 := by numbers

  calc
    n ^ 4 - 2 * n ^ 2
    _ = (n ^ 2 - 1) ^ 2 - 1 := by ring
    _ = (n - 1) ^ 2 * (n + 1) ^ 2 - 1 := by ring
    _ = (n ^ 2 - 2 * n + 1) * (n ^ 2 + 2 * n + 1) - 1 := by ring
    _ = (n ^ 4 - 3 * n ^ 3 - 2 * n ^ 2 - 1) + 3 * n ^ 3 + 1 := by ring
    _ ≥ 3 * n ^ 3 + 1 := by extra
    _ > 3 * n ^ 3 := by extra
